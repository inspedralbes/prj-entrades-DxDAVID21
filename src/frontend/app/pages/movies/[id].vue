<template>
      ...
      <div class="lg:col-span-2">
        <div class="mb-4">
          ...
          <div class="flex flex-wrap gap-3 mb-4">
            ...
            <span
              v-if="movie.rating"
              class="bg-[#F7C600] text-black px-3 py-1 rounded-full text-sm font-bold"
            >
  ...
  <div v-else class="container mx-auto px-4 py-16 text-center">
    ...
    <NuxtLink to="/movies">
      <UButton color="primary"> Tornar a les pel·lícules </UButton>
    </NuxtLink>
  </div>
</template>
